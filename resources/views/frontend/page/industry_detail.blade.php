...
@section('content')
    @include('frontend.module.industry.title')
    <!-- main content -->
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <h3 class="c-giant-card__title">
                                    {{ $industry_detail->second_title }}
                                </h3>
                                <div class="c-giant-card__content">
                                    {!! $industry_detail->second_title_subtitle !!}
                                </div>
                            </div>
                            <div class="col-lg-5 offset-lg-1">
                                <img class="c-giant-card__img c-giant-card__img--narrow"
                                    src="{{ asset('/storage/industry_photos/' . $industry_detail->image) }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="c-giant-card c-giant-card--vertical">
                        ...
                        <div class="c-giant-card__content">
                            <div class="c-giant-card__content-inner mb-4">
                                {!! $industry_detail->second_title_subtitle !!}
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="c-title">
                        <h3 class="c-title__heading c-title__heading--no-mg">
                            {{ $industry_detail->content_area_title }}
                        </h3>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="c-vertical-tab">
                        <div class="nav flex-column c-vertical-tab__pill-wrapper" id="v-pills-tab" role="tablist"
                            ...
                            @foreach ($industry_detail->content as $key => $c)
                        ...
                        <div class="tab-content c-vertical-tab__content-wrapper" id="v-pills-tabContent">
                            @foreach ($industry_detail->content as $key => $cc)
                                <div class="tab-pane c-vertical-tab__content fade {{ $key == 0 ? 'show active' : '' }} "
                                    id="pills_{{ $cc->content_guid }}" role="tabpanel" aria-labelledby="pills-security-tab">
     ...
     @endforeach
                                        ...
                                        <div class="col-1 d-none d-sm-flex align-items-center justify-content-center">
                                            <div class="c-slider--services__nextBtn">
                                                <img src="{{ asset('frontend/assets/images/slider-next.svg') }}"
                                                    alt="">
