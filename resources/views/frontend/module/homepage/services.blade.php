<!-- services section -->
<section class="c-section c-section--lg pb-0 ">
    <div class="container">
        <div class="row u-mg-b-30 u-mg-lg-b-0">
            <div class="col-md-12 col-lg-7">
                <div class="c-title">
                    <h3 class="c-title__heading c-title__heading c-title__heading--dark">
                        {{$alt_baslik->text}}
                    </h3>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-1 d-none d-sm-flex align-items-center justify-content-end">
                        ...
                        <div class="c-service-card__wrapper">
                            <div class="c-service-card">
                                <div class="c-service-card__head">
                                    <img class="owl-lazy" data-src="{{ asset('frontend/assets/images/'. $i->icon.'.svg' ) }}" alt=" {{ $i->name}}">
                                </div>
            ...
            <div class="col-1 d-none d-sm-flex align-items-center justify-content-stat">
