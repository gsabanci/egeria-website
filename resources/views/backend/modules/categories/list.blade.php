...
<div class="card card-custom">
    ...
    <div class="card-header border-0 py-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label font-weight-bolder text-dark">Kategoriler</span>
            <span class="text-muted mt-3 font-weight-bold font-size-sm">Aşağıda sistemde yer alan kategorileri
                görebilirsiniz.</span>
        </h3>
    </div>
    <!--end::Header-->
            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_4">
                <thead>
                    <tr class="text-left">
                        ...
                        <th style="min-width: 200px">Dil</th>
                ...
                <tbody>
                    @foreach ($category as $c)
                        <tr>
                            ...
                            <td>{{ !is_null($c->queue) ? $c->queue : 'Belirlenmemiş' }}</td>
                            <td class="pr-0 text-right">
                                <a href="#" data-toggle="modal" data-target="#modal_{{ $c->c_guid }}"
                                ...
                                <a href="#" data-toggle="modal" data-target="#delete_{{ $c->c_guid }}"
                        ...
                        <div class="modal fade" id="modal_{{ $c->c_guid }}" tabindex="-1" role="dialog"
                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                 <form action="{{ route('admin.category_update', $c->c_guid) }}" method="POST">
                                @csrf
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <label for="slug" class="col-form-label">ID</label>
                                            <input type="text" class="form-control" name="slug" value="{{ $c->slug }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="c_guid" value="{{ $c->c_guid }}">
                                            </div>
                                        </div>
                        ...
                        <div class="modal" id="delete_{{ $c->c_guid }}" tabindex="-1" role="dialog">
                            <form action="{{ route('admin.category_delete', $c->c_guid) }}" method="POST">
                                @csrf
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
