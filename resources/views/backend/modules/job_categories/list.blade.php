...
<div class="card card-custom">
    ...
    <div class="card-header border-0 py-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label font-weight-bolder text-dark">İş Kategorileri</span>
            <span class="text-muted mt-3 font-weight-bold font-size-sm">Aşağıda sistemde yer alan iş kategorilerini
                görebilirsiniz.</span>
        </h3>
    </div>
    <!--end::Header-->
            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_4">
                ...
                <tbody>
                    @foreach ($category as $c)
                        <tr>
                            ...
                            <td class="pr-0 text-right">
                                <a href="#" data-toggle="modal" data-target="#modal_{{ $c->jc_guid }}"
                                ...
                                <a href="#" data-toggle="modal" data-target="#delete_{{ $c->jc_guid }}"
                        ...
                        <div class="modal fade" id="modal_{{ $c->jc_guid }}" tabindex="-1" role="dialog"
                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <form action="{{ route('admin.job_category_update') }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Kategori Detay
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="jc_guid" value="{{ $c->jc_guid }}">
                                            </div>
                                        </div>
                        ...
                        <div class="modal" id="delete_{{ $c->jc_guid }}" tabindex="-1" role="dialog">
                            <form action="{{ route('admin.job_category_delete') }}" method="POST">
                                @csrf
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            <p>{{ $c->name }} kategorisini silmek istediğinize emin misiniz?</p>
                                        </div>
                                        <input type="hidden" name="jc_guid" value="{{ $c->jc_guid }}">
                                        <div class="modal-footer">
                    ...
                    <div class="modal fade" id="{{ $data['button']['id'] }}" tabindex="-1" role="dialog"
                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <form action="{{ route('admin.job_category_add') }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">İş Kategorisi Ekle</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
