...
<head>
    ...
    <link href="{{ asset('backend/')}}/assets/css/login-3.css" rel="stylesheet" type="text/css" />
...
<body id="kt_body"
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="login login-3 login-signin-on d-flex flex-row-fluid" id="kt_login">
            <div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid"
                style="background-image: url({{ asset('backend/')}}/assets/media/bg/bg-1.png);">
                <div class="login-form text-center text-white p-7 position-relative overflow-hidden">
                    <!--begin::Login Header-->
                    <div class="d-flex flex-center mb-15">
                        <a href="#">
                            <img src="{{ asset('backend/')}}/assets/media/logos/logo-light.png" class="max-h-100px"
                                alt="" />
                        </a>
                    </div>
                    <!--end::Login Header-->
                    ...
                    <div class="login-signin">
                        ...
                        <form method="POST" action="{{  route('admin.do_login')  }}" class="form"
                            ...
                            <div class="form-group">
                                <input
                                    ...
                                    type="text" placeholder="Email" id="email" name="email" autocomplete="off" />
                            </div>
                            <div class="form-group">
                                <input
                                    class="form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8 mb-5"
    ...
    <script src="{{ asset('backend/')}}/assets/js/theme/scripts.bundle.js"></script>
    <!--end::Global Theme Bundle-->
    <!--begin::Page Scripts(used by this page)-->
    <script src="{{ asset('backend/')}}/assets/js/theme/login-general.js"></script>
    <script>
        @if(Session::has('error'))
            toastr.warning('Girdiğiniz Email yada password yanlış yanlış.');
        @endif
    </script>
    <!--end::Page Scripts-->
</body>
