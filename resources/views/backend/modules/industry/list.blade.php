                    ...
                    @foreach($industries as $industry)
                        <tr>
                            ...
                            <td class="pr-0 text-right">
                                ...
                                <a href="#" data-toggle="modal" data-target="#modal_{{ $industry->industry_guid }}"
                                    class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
                                ...
                                <a href="#" data-toggle="modal" data-target="#delete_{{ $industry->industry_guid }}"
                        ...
                        <div class="modal fade" id="modal_{{ $industry->industry_guid }}" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('admin.industry_edit', $industry->industry_guid) }}"
                                        method="POST">
                                        <div class="modal-body">
                                            ...
                                            <input type="hidden" name="industry_guid"
                                                value="{{ $industry->industry_guid }}">
                                            <div class="form-group">
