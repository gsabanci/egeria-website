...
<div class="card card-custom">
    ...
    <div class="card-header border-0 py-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label font-weight-bolder text-dark">Site İçerikleri</span>
            <span class="text-muted mt-3 font-weight-bold font-size-sm">Aşağıda site içeriklerini görebilirsiniz.</span>
        </h3>
    </div>
    <!--end::Header-->
    <!--begin::Body-->
            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_4">
                ...
                <tbody>
                    @foreach ($settings as $s)
                        ...
                        <div class="modal fade" id="modal_{{ $s->setting_guid }}" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('admin.setting_update') }}" method="POST"
                                        ...
                                        <div class="modal-body ">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-6">
                                                    <label for="recipient-name" class="col-form-label">Ayar
                                                        Resmi</label>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-12">
                                                    ...
                                                    <textarea type="text" class="summernote" name="text">{{ $s->text }}</textarea>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-6">
                                                            <label for="recipient-name"
                                                                class="col-form-label">Başlık</label>
                                                            <input type="text" class="form-control"
                                                                value="{{ $ac->title }}" name="ac_title[]">
                                                        </div>
                                                        <div class="form-group col-6">
                                                            <label for="recipient-name"
                                                                class="col-form-label">Link</label>
                                                            <input type="text" class="form-control"
                                                                value="{{ $ac->link }}" name="ac_link[]">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="form-group col-12">
                                                            <label for="recipient-name"
                                                                class="col-form-label">İçerik</label>
                                                            <textarea type="text" class="form-control" name="ac_content[]">{{ $ac->content }}</textarea>
                                                        </div>
                                                    </div>
                                                @endforeach
                                            @endif
